...
import { AddressStatus } from '../qi-hdwallet.js';
 ...
 */
export function generatePaymentCodePrivate(root, account) {
 ...
 */
export function getPrivateKeyFromPaymentCode(root, counterPartyPaymentCode, index, account) {
    const bip32 = BIP32Factory(ecc);
...
class Bip47QiWalletSelf extends AbstractQiWallet {
    root;
     ...
     */
    getPaymentCodePrivate(account = 0) {
...
export { Bip47QiWalletSelf };
//# sourceMappingURL=bip47-self-qi-wallet.js.map