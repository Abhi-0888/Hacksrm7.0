 ...
 * @module wallet/utils
 */
import { getBytesCopy, assertArgument, concat, dataSlice, getBytes, assert, getZoneForAddress, } from '../utils/index.js';
 ...
 */
export function isValidAddressForZone(coinType, address, zone) {
