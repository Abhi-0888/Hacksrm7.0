import { AbstractHDWallet, NeuteredAddressInfo } from './abstract-hdwallet.js';
...
export declare class QuaiHDWallet extends AbstractHDWallet<NeuteredAddressInfo> {
     ...
     */
    getNextAddress(account: number, zone: Zone, useReactNative?: boolean): Promise<NeuteredAddressInfo>;
    /**
    ...
    protected _getNextAddressReactNativeAsync(accountIndex: number, zone: Zone): Promise<NeuteredAddressInfo>;
    /**
