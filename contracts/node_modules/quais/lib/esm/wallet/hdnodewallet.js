...
export class HDNodeWallet extends BaseWallet {
    ...
    async deriveChildReactNative(_index) {
        ...
        const childPriv = await fastCrypto.secp256k1.privateKeyTweakAdd(getBytes(this.privateKey), // 32-byte parent key
        ...
        const newWallet = new HDNodeWallet(_guard, ki, this.fingerprint, hexlify(IR), path, index, this.depth + 1, this.mnemonic, this.provider, fingerprint, address);
        return newWallet;
    }
    /**
    ...
    async addressFromUncompressed(uncompressed, quickCrypto) {
         ...
         * ----------------------------------------------------------- */
        const chkBytes = quickCrypto.keccak256(Buffer.from(addrHex, 'utf8')); // ascii string → bytes
