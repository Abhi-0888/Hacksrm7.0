...
export declare const DefaultShardPorts: {
    prime: number;
    cyprus: number;
    cyprus1: number;
    cyprus2: number;
...
export declare class AbstractProvider<C = FetchRequest> implements Provider {
    ...
    calculateConversionAmount(fromOrArgs: string | ConversionTransactionRequest, to?: string, value?: BigNumberish): Promise<bigint>;
