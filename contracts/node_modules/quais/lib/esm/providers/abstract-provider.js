                ...
                if (shardsArray) {
                    ...
                    shardsArray[0].forEach((shard) => {
                        ...
                        const port = shardPorts && shardNickname in shardPorts
                            ...
                            : DefaultShardPorts[shardNickname];
                    ...
                    if (!this.#options.usePathing) {
                        ...
                        this._urlMap.set(Shard.Cyprus1, urls);
                        ...
                        shards.forEach((shard) => {
                            ...
                            const path = shardPaths && shardNickname in shardPaths
                                ...
                                : `/${shardNickname}`;
                            const shardSuffix = this.#options.usePathing ? `${path}` : `:${port}`;
                            this._urlMap.set(shardEnum, new FetchRequest(this.constructUrl(urls.url, shardSuffix)));
                        });
                    }
                }
                return;
                ...
                for (let urlIndex = 0; urlIndex < urls.length; urlIndex++) {
                    ...
                    if (shardsArray) {
                        ...
                        if (!this.#options.usePathing) {
                            ...
                            this._urlMap.set(Shard.Cyprus1, connect);
                            ...
                            shards.forEach((shard) => {
                                ...
                                const path = shardPaths && shardNickname in shardPaths
                                    ...
                                    : `/${shardNickname}`;
                                const shardSuffix = this.#options.usePathing ? `${path}` : `:${port}`;
                                this._urlMap.set(toShard(`0x${shard[0].toString(16)}${shard[1].toString(16)}`), new FetchRequest(this.constructUrl(urls[urlIndex], shardSuffix)));
                            });
                        }
                    }
                }
