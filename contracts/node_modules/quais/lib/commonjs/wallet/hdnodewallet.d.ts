...
export declare class HDNodeWallet extends BaseWallet {
     ...
     */
    constructor(guard: any, signingKey: SigningKey, parentFingerprint: string, chainCode: string, path: null | string, index: number, depth: number, mnemonic: null | Mnemonic, provider: null | Provider, childFingerprint?: string, address?: string);
    /**
     ...
     */
    deriveChildReactNative(_index: Numeric): Promise<HDNodeWallet>;
    /**
     ...
     */
    addressFromUncompressed(uncompressed: Uint8Array, quickCrypto: any): Promise<string>;
    /**
     ...
     */
    static fromSeedReactNative(seed: BytesLike): Promise<HDNodeWallet>;
    /**
     * Native phrase -> seed -> derive path
     */
    static fromMnemonicReactNative(mnemonic: Mnemonic, path: string): Promise<HDNodeWallet>;
    /**
     * Helper to attach mnemonic & keep typing clean
     */
    private connectMnemonic;
    /**
