...
exports.isValidAddressForZone = exports.ser_I = exports.encodeBase58Check = exports.zpad = exports.Nibbles = exports.N = exports.HardenedBit = exports.MasterSecret = exports.spelunk = exports.getPassword = exports.looseArrayify = exports.MAX_ADDRESS_DERIVATION_ATTEMPTS = exports.HARDENED_OFFSET = void 0;
 ...
 */
function isValidAddressForZone(coinType, address, zone) {
    const addressZone = (0, index_js_1.getZoneForAddress)(address);
    if (!addressZone) {
        return false;
    }
    const isCorrectShard = addressZone === zone;
    const isCorrectLedger = coinType === 969 ? (0, index_js_4.isQiAddress)(address) : !(0, index_js_4.isQiAddress)(address);
    return isCorrectShard && isCorrectLedger;
}
exports.isValidAddressForZone = isValidAddressForZone;
