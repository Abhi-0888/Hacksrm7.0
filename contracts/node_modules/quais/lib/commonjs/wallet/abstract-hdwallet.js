...
exports.AbstractHDWallet = exports._guard = void 0;
...
class AbstractHDWallet {
    ...
    static async fromMnemonicReactNative(mnemonic) {
        const coinType = this._coinType;
        const path = this.parentPath(coinType);
        const root = await hdnodewallet_js_1.HDNodeWallet.fromMnemonicReactNative(mnemonic, path);
        return new this(exports._guard, root);
    }
    /**
    ...
    static createInstanceFromRoot(root, seed) {
        return new this(exports._guard, root, seed);
    }
    /**
    ...
    static fromSeed(seed) {
        let root = hdnodewallet_js_1.HDNodeWallet.fromSeed(seed);
        const coinType = this._coinType;
        const path = this.parentPath(coinType);
     ...
     */
    validateZone(zone) {
        if (!Object.values(index_js_3.Zone).includes(zone)) {
    ...
    validateBaseAddressInfo(info) {
        ...
        if (!Object.values(index_js_3.Zone).includes(info.zone)) {
