 ...
 * ```
 */
class QuaiHDWallet extends abstract_hdwallet_js_1.AbstractHDWallet {
    /**
    ...
    constructor(guard, root, provider) {
        ...
        this.bip44 = new bip44_js_1.BIP44(root, QuaiHDWallet._coinType);
    }
    /**
    ...
    static async deserialize(serialized) {
        ...
        const wallet = new this(abstract_hdwallet_js_1._guard, root);
    ...
    _getNextAddress(accountIndex, zone) {
        ...
        const addressNode = this.bip44.deriveNextAddressNode(QuaiHDWallet._coinType, accountIndex, lastIndex + 1, zone, false);
        return this._createAndStoreNeuteredAddressInfo(addressNode, accountIndex, zone);
    }
    async _getNextAddressReactNativeAsync(accountIndex, zone) {
        this.validateZone(zone);
        const lastIndex = this._findLastUsedIndex(Array.from(this._addresses.values()), accountIndex, zone);
        const addressNode = await this.bip44.deriveNextAddressNodeReactNativeAsync(accountIndex, lastIndex + 1, zone, false);
        return this._createAndStoreNeuteredAddressInfo(addressNode, accountIndex, zone);
    }
    /**
