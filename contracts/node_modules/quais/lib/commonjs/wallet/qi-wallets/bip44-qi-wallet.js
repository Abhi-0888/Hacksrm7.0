...
exports.Bip44QiWallet = void 0;
const abstract_qi_wallet_js_1 = require("./abstract-qi-wallet.js");
const qi_hdwallet_js_1 = require("../qi-hdwallet.js");
const index_js_1 = require("../../utils/index.js");
const index_js_2 = require("../../address/index.js");
class Bip44QiWallet extends abstract_qi_wallet_js_1.AbstractQiWallet {
    bip44;
    isChange;
    static DEFAULT_GAP_LIMIT = 5;
    constructor(bip44, isChange) {
     ...
     */
    deriveNewAddress(zone, account = 0) {
        ...
        const qiAddressInfo = {
            ...
            status: qi_hdwallet_js_1.AddressStatus.UNKNOWN,
    ...
    async deriveNewAddressReactNativeAsync(zone, account = 0) {
        const index = this.getLastDerivationIndex(zone, account) + 1;
    ...
    addAddress(account, addressIndex) {
        ...
        if (this.getAddressesForAccount(account).some((addr) => addr.index === addressIndex)) {
            throw new Error(`Address index ${addressIndex} already exists in wallet under account ${account} and derivation path ${derivationPath}`);
        }
        const addressNode = this.getAddressNode(account, addressIndex);
        const zone = (0, index_js_1.getZoneForAddress)(addressNode.address);
        if (!zone) {
            throw new Error(`Failed to derive a Qi valid address zone for the index ${addressIndex}`);
        }
        if (!(0, index_js_2.isQiAddress)(addressNode.address)) {
...
exports.Bip44QiWallet = Bip44QiWallet;
//# sourceMappingURL=bip44-qi-wallet.js.map