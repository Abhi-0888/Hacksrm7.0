...
class SigningKey {
    #privateKey;
    #cachedCompressed; // store once, reuse forever
    /**
     * Creates a new **SigningKey** for `privateKey`.
     */
    constructor(privateKey, compressedPub) {
        ...
        if (compressedPub) {
            (0, index_js_1.assertArgument)((0, index_js_1.dataLength)(compressedPub) === 33, 'invalid public key', 'compressedPub', compressedPub);
            this.#cachedCompressed = (0, index_js_1.hexlify)(compressedPub);
        }
    }
    /**
     * The private key.
