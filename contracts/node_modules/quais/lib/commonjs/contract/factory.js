...
class ContractFactory {
     ...
     */
    constructor(abi, bytecode, runner, IPFSHash = null) {
    ...
    async deploy(...args) {
        ...
        (0, index_js_2.assert)(this.IPFSHash !== null && this.IPFSHash !== undefined && this.IPFSHash.length == 46, `IPFSHash is ${this.IPFSHash} not set or not 46 characters long`, 'BAD_DATA', {
            value: 'IPFSHash',
        });
