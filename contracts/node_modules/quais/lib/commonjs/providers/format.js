...
const _formatHeader = object({
    avgTxFees: index_js_4.getBigInt,
    baseFeePerGas: index_js_4.getBigInt,
    conversionFlowAmount: index_js_4.getBigInt,
    ...
    kQuaiDiscount: index_js_4.getBigInt,
    manifestHash: arrayOf(formatHash),
    minerDifficulty: index_js_4.getBigInt,
    ...
    totalFees: index_js_4.getBigInt,
