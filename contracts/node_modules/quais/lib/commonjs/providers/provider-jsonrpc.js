            ...
            while (payloads.length) {
                ...
                (async () => {
                    ...
                    const processPayloads = async (key, value, now) => {
                        ...
                        const shard = key
                            ? (0, index_js_5.toShard)(key)
                            : this._urlMap.has(index_js_5.Shard.Prime)
                                ? index_js_5.Shard.Prime
                                : this._urlMap.keys().next().value;
                        const zone = shard && shard.length === 4 ? (0, index_js_5.toZone)(shard) : index_js_5.Zone.Cyprus1;
